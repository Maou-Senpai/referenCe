...
PageLibString::PageLibString()
{
    libFunctions = new std::vector<dictionary *>;
    dictionaryFiller(":/txt/content/libstring.txt", libFunctions);
}
...
void PageLibString::getDictionaries(std::vector<std::vector<dictionary *> *> *collectiveDict)
{
